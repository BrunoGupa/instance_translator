...
def find_B_suf(nodes, instance, burnt_nodes, A, distance, time, binary_dic, json_name_bin, cvs_name_bin,
    ...
    if not_interrupted:
        if not is_upper_bound:
            B += 1
            find_B_suf(nodes, instance, burnt_nodes, A, distance, time, binary_dic,
                       json_name_bin, cvs_name_bin, B, D, node_list, instances)


def run_and_save(nodes, instance, burnt_nodes, A, distance, D, B, time, binary_dic, json_name_bin, cvs_name_bin,
    ...
    binary_dic[0].append([[nodes, burnt_nodes, instance],
